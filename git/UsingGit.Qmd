...
If the branch will no longer be used, click "*Delete branch*" to delete the `r glossary("branch")` from the `r glossary("remote")` `r glossary("repository")`.
