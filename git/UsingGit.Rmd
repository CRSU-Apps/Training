...
```{r, label = "resgistration", dpi=96, fig.align = "center", echo = FALSE, fig.cap ="Installing Git using Software Centre"}
...
```{r, label = "install-tools", dpi=96, fig.align = "center", echo = FALSE, fig.cap ="Installing Git using Software Centre"}
...
```{r, label = "preferences", dpi=96, fig.align = "center", echo = FALSE, fig.cap ="Installing Git using Software Centre"}
...
```{r, label = "home", dpi=96, fig.align = "center", echo = FALSE, fig.cap ="Installing Git using Software Centre"}
...
```{r, label = "new-repo-button", dpi=75, fig.align = "center", echo = FALSE, fig.cap ="Green new repository button in GitHub"}
...
```{r, label = "create-new-repo", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of filling in the form to set up a new repository in GitHub"}
...
```{r, label = "new-repo", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of a newly created repository in GitHub"}
...
```{r, label = "clone", dpi=110, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of how to find the URL for a GitHub repository"}
...
```{r, label = "cloned", dpi=110, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of how to find the URL for a GitHub repository"}
...
```{r, label = "diff-files", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree having detected changes"}
...
```{r, label = "diff-change", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the 'diff' for an updated file"}
...
```{r, label = "staged", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the files staged"}
...
```{r, label = "committed", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the files staged"}
...
Note that in the top-left of the *Sourcetree* window, the *Push* button has a `1` badge on it. This is showing that there is 1 local commit which has not yet been pushed to the remote repository. Clicking that button will open a dialog to configure that "push" \@ref(fig:push).

```{r, label = "push", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the 'push' dialog"}
...
When you push for the first time, you will likely be faced with a window as seen in figure \@ref(fig:credentials) to link your *GitHub* account. Choose *Sign in with your browser* and then simply sign in (if you're already signed in on your web browser you may not need to do anything).

```{r, label = "credentials", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the GitHub sign in dialog"}
...
```{r, label = "pushed", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "pushed-github", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "revert", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
Instead of committing changes from another computer, changes can be committed directly on *GitHub*. Go to the home page of the respoitory and click the pencil button in the top-right of the README panel, as shown in \@ref(fig:github-edit).

```{r, label = "github-edit-button", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
knitr::include_graphics("images/github/github_edit_button.png")
```

Make some changes, then click the *Commit Changes* button.

```{r, label = "github-edit", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "github-commit", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "fetch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
knitr::include_graphics("images/sourcetree/sourcetree_fetch.png")
```

*Sourcetree* will show the *History* tab, selecting and bolding the commit on which the local changes are based, as in \@ref(fig:fetched).

```{r, label = "fetched", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "pull", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "pulled", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
Pulling changes to a file which has unbcommitted local changes will result in an error, as shown in \@ref(fig:uncommitted-pull). The changes must be committed before the pull can be completed.

```{r, label = "uncommitted-pull", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "resolve-conflict", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "resolve-conflicts-menu", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "resolved-conflict-commit", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
knitr::include_graphics("images/sourcetree/sourcetree_resolved_conflict_commit.png")
```

The *Histopry page will be shown again with the changes merged in, as if \@ref(fig:resolved-conflict-pushed).

```{r, label = "resolved-conflict-pushed", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "github-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "github-branches", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "github-new-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "github-new-branches", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "checkout-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "checkout-new-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
knitr::include_graphics("images/sourcetree/sourcetree_checkout_new_branch.png")
```

### Using *Sourcetree*

Before a branch is to be created, the base for the new branch must be checked out. This is described in \@ref(checkout). A branch on the local respository can also be used as a base, by checking out the local branch within the "Branches" section in the left-hand panel.
...
```{r, label = "sourcetree-create-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "push-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of Sourcetree showing the history tab after pushing"}
...
```{r, label = "add-aims", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "recent-push", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "pull-requests", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "new-pull-request", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "create-pull-request", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "created-pull-request", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "confirm-merge", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "delete-remote-branch-github", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "github-merged", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "post-merge-checkout", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "select-merge-commit", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "delete-local-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
...
```{r, label = "delete-remote-branch", dpi = 50, fig.align = "center", echo = FALSE, fig.cap = "Screenshot of GitHub illustrating branches being ahead of main branch"}
